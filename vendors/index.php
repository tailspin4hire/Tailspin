...
$username = $_SESSION['username'] ?? 'Vendor'; // Prevent undefined array key error
      ...
      <div class="col-12 col-xl-7 pages-links">
        <div class="d-flex justify-content-between flex-wrap">
          <a href="addaircraft.php" class="btn btn-primary mb-2">List An Aircraft</a>
           <a href="addparts.php" class="btn btn-primary mb-2">List A Part</a>
          <a href="addengines.php" class="btn btn-primary mb-2">List An Engine</a>
         
          <a href="add_services.php" class="btn btn-primary mb-2">List A Service</a>

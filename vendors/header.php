...
<body>
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="product-management">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"><a class="nav-link" href="addengines.php">List An Engine</a></li>
          <li class="nav-item"><a class="nav-link" href="addparts.php">List A Parts</a></li>
          <li class="nav-item"><a class="nav-link" href="manage_products.php">My Listings</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#service-management" aria-expanded="false" aria-controls="service-management">
        <i class="icon-tag menu-icon"></i>
      ...
      <div class="collapse" id="service-management">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"><a class="nav-link" href="add_services.php">LIst A Service</a></li>
          <li class="nav-item"><a class="nav-link" href="list_of_services.php">Services Listings</a></li>
    ...
    <!-- Orders Management -->
    <!--<li class="nav-item">-->
    <!--      <a class="nav-link" href="vendor_backlinks.php">-->
    <!--        <i class="icon-link menu-icon"></i>-->
    <!--        <span class="menu-title">My Backlinks</span>-->
    <!--      </a>-->
    <!--    </li>-->
    <li class="nav-item">

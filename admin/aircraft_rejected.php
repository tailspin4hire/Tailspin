...
// Fetch all rejected aircraft products
  ...
  <div class="content-wrapper">
    <div class="row">
      <div class="col-md-12 grid-margin">
        <h3 class="font-weight-bold">Rejected Aircraft Products</h3>
        <h6 class="font-weight-normal mb-0">View all aircraft products that have been rejected.</h6>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Rejected Aircraft List</h4>
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  <?php else: ?>
                    <tr>
                      <td colspan="11" class="text-center">No rejected aircraft found.</td>
                    </tr>
                  <?php endif; ?>
                </tbody>
              </table>

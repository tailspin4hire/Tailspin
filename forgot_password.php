...
<div class="main">
    <div class="form-wrapper">
        <div class="form-container">
            <h2 style='font-family: "EB Garamond", serif; margin-bottom:5px;'>Forgot Password</h2>
            ...
            <form id="forgotPasswordForm" method="POST" action="send_reset_link.php">
                ...
                <button type="submit" class="toggle-btn">Send Reset Link</button>
            </form>

            <p style="margin-top: 15px;"><a href="login.php">Back to Login</a></p>
            <div id="forgotMessageBox"></div>
        </div>
    </div>
</div>
